...
send_subject = 'HKR'# 本次邮件发送的主题
send_file = open(r'D:\python\day17【自动化测试框架】\代码\HKRJ.html', 'rb').read()
...
msg['Content-Disposition'] = 'attachment;filename="hkrj.html"'
# 创建一个带附件的实例
